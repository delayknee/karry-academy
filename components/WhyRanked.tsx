      ...
      <div className="mt-14 grid gap-5 lg:grid-cols-3">
        {problems.map(({ Icon, title, body }, i) => (
          <Reveal
            ...
            delay={120 + i * 80}
            y={18}
            className="relative rounded-ow-1 border border-ow-line2 bg-ow-bg2 p-8 shadow-[0_1px_2px_rgba(11,18,32,0.04)]"
          >
            <div className="mb-6 flex items-center justify-between">
              <div className="flex h-12 w-12 items-center justify-center rounded-ow-1 border border-ow-orange/30 bg-ow-orange/[0.08] text-ow-orange">
